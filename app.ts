...
app.all(/\/tests\/(.*)/, (req: Request, res: Response) => {
  ...
  if (req.query.flag1_name) {
    flags.push({
      ...
      name: String(req.query.flag1_name).trim(),
      value_to_set: String(req.query.flag1_value_to_set).trim(),
    });
  }
  ...
  if (req.query.flag2_name) {
    flags.push({
      ...
      name: String(req.query.flag2_name).trim(),
      value_to_set: String(req.query.flag2_value_to_set).trim(),
    });
  }
