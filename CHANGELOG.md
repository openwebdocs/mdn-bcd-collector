...
- Use local JavaScript to determine if secure context
- Update readme
...
- Trim trailing newline in dev version
- Improve GitHub export error catching
- Replace appspot.com-&gt;gooborg.com following new deployments
- Use GITHUB_TOKEN from env variables if not available in secrets.json
- Add Procfile
