...
- Add tests for JS feature Change Array by copy ([#2494](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2494))
- Improve release filter argument in update-bcd script ([#2475](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2475))
- Remove IDL for proprietary features not in BCD or removed from BCD ([#2474](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2474))
- Remove IDL for DOM features removed from BCD ([#2468](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2468))
- Remove IDL for BlobBuilder ([#2469](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2469))
- Remove IDL for HTML features removed from BCD ([#2470](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2470))
- Remove IDL for CanvasCaptureMediaStream API ([#2471](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2471))
- Remove IDL for LocalMediaStream API ([#2472](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2472))
- Remove custom IDL for Notification API ([#2473](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2473))
- Remove IDL for CSS features removed from BCD ([#2465](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2465))
- Remove custom IDL for proprietary DataCue.data ([#2466](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2466))
- Remove IDL for directory upload spec ([#2467](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2467))
- Remove IDL for proprietary IDBDatabase.createMutableFile ([#2461](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2461))
- Remove IDL for SVG features removed from BCD ([#2462](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2462))
- Remove IDL for DOMException extensions ([#2463](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2463))
- Remove IDL for budget APIs ([#2464](https://github.com/GooborgStudios/mdn-bcd-collector/pull/2464))
